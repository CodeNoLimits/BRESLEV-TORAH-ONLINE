...
export interface CompleteBreslovText {
  ...
  verified: boolean;
  segmentCount?: number;
  notice?: string; // Pour les textes non disponibles
}
...
export const ALL_BRESLOV_TEXTS: CompleteBreslovText[] = [
  ...
  // Likutei Tefilot - AUTHENTIQUES références Sefaria seulement  
  // Note: Likutei Tefilot.1-210 n'existent PAS sur Sefaria
  // Remplacé par les textes VRAIMENT disponibles
  {
    title: "Likutei Tefilot - Collection non disponible",
    ref: "unavailable_likutei_tefilot",
    hebrewTitle: "ליקוטי תפילות - אוסף לא זמין",
    category: "Notice",
    verified: false,
    segmentCount: 1,
    notice: "Ces textes ne sont pas disponibles sur l'API Sefaria"
  },
  ...
  // Sefer HaMiddot - STRUCTURE COMPLEXE NON SUPPORTÉE PAR SEFARIA API
  // L'API retourne : "You passed 'Sefer HaMiddot', please pass a more specific ref"
  // Ce livre a une structure complexe non compatible avec notre système
  {
    title: "Sefer HaMiddot - Structure complexe non supportée",
    ref: "unavailable_sefer_hamiddot",
    hebrewTitle: "ספר המידות - מבנה מורכב לא נתמך",
    category: "Notice",
    verified: false,
    segmentCount: 1,
    notice: "Ce livre nécessite une structure spéciale non implémentée dans l'API Sefaria"
  },

  // COLLECTIONS AUTHENTIQUES RESTAURÉES (post-vérification Sefaria)

  // Likkutei Etzot - COLLECTION AUTHENTIQUE COMPLÈTE
  ...
  // Shivchei HaRan - COLLECTION RÉDUITE AUX CHAPITRES PRINCIPAUX  
  ...Array.from({ length: 50 }, (_, i) => ({
  ...
  // Alim LiTerufah - COLLECTION AJOUTÉE
  ...
  // Kitzur Likutei Moharan - COLLECTION AJOUTÉE
